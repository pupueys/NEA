...
/* Initialises the specified serial port and buffers */
...
/* Function to output a character to the TDR */
void SerialOutputChar(uint8_t data, SerialPort *serial_port);

/* Function to ouput a given string */
void SerialOutputString(uint8_t *pt, SerialPort *serial_port);

/* Function to receive a character from RDR and store it */
void SerialReceiveChar(uint8_t *pt, SerialPort *serial_port);

/* Function to receive a string into a pre-defined buffer */
